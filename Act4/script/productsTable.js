class ProductsTable {
    ...
    setTableRows() {
        ...
        this.#products.forEach(product => {
            ...
            const addQuantityToHTML = `<td class="product-table__cell--input"><button onclick="decrement()">-</button><input type="number" id="quantity" value="1"><button onclick="increment()">+</button></td>`;
            const addPriceToHTML = `<td class="product-table__cell"><p>$(product.price)</p></td>`;
            const addTotalPriceToHTML = `<td class="product-table__cell"><p>$(product.price)</p></td>`;
